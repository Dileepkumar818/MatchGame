...
class App extends Component {
  ...
  render() {
    const {activeTabId, imgMatch, time, score, isGameover} = this.state
        ...
        <div>
          {!isGameover ? (
            <div className="bg-img">
              <div>
                <img className="image" src={imgMatch.imageUrl} alt="match" />
              </div>
              <div>
            ...
            <div>
              <GameScoreBanner score={score} resetGame={this.resetGame} />
            </div>
          )}
        </div>
      </div>
